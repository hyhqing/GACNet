...
class _BoundaryAwareness(nn.Module):
    ...
    def __init__(self, in_fea=[32, 64], mid_fea=48, out_fea=1):#由2改为1
...
class PoseHighResolutionNet(nn.Module):
    ...
    def __init__(self, cfg, num_class, in_chans, **kwargs):
        self.inplanes = 64
        super(PoseHighResolutionNet, self).__init__()

        # stem net
        self.conv1 = nn.Conv2d(in_chans, 64, kernel_size=3, stride=2, padding=1,
                               bias=False)
