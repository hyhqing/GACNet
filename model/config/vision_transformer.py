...
class PatchEmbed(nn.Module):
    ...
    """
    def __init__(self, in_chans, img_size=256, patch_size=16, embed_dim=768):
        super().__init__()
...
class VisionTransformer(nn.Module):
    ...
    """
    def __init__(self, in_chans, img_size=256, patch_size=16, num_classes=2, embed_dim=768, depth=12,
